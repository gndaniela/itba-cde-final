...
def parse_csv_parquet(source, dest):
    ...
    df = (
        df.withColumn("target", when(col("home_team_result") == "Win", 1).otherwise(0))
        ...
        .withColumn(
            ...
            df.home_team_total_fifa_points.cast(IntegerType()),
        )
        .withColumn(
            "away_team_total_fifa_points",
            df.away_team_total_fifa_points.cast(IntegerType()),
        )
